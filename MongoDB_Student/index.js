...
const StudentMarks = require("./studentMarks.js")
const app = express()
...
const db_connection = "mongodb+srv://dubbewararya05:dubbewararya05@cluster0.0in6gov.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
const port = 2324
...
app.get("/getMoreThan20InDSBDA", async function (request, response) {
    const students = await StudentMarks.find({ DSBDA_Marks: { $gt: 20 } }, { Roll_No: true }) // 2nd parameter is for displaying only name
